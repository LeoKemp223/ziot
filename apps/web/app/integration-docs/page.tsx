                    ...
                    value={`# ① 订阅 /ota/{pk}/{dk}/upgrade/notify，收到升级通知：
{
  ...
  "firmware": {
    "version": "v1.0.1",
    "file_url": "https://www.ziot.asia/ziot-firmwares/firmwares/.../fw.bin",
    "file_size": 204800,
    "sha256": "0000...64位十六进制"
  }
}
...
# 差分固件的通知会附加以下字段（整包不下发，老设备可安全忽略）：
{
  ...
  "firmware": {
    "version": "v1.0.2",
    "file_url": "https://www.ziot.asia/ziot-firmwares/firmwares/.../v1.0.1-v1.0.2.patch",
    "file_size": 10240,
    "sha256": "补丁文件的 sha256",
    "package_type": "delta",
    "base_version": "v1.0.1",
...
# ② 用 HTTP GET 下载 file_url（永久公共直链，无签名无过期；大文件可 Range 断点续传），
